...
namespace Votyra.Cubical.Tests.Editor.TerrainMesher3bTests
{
    ...
    {
        public static readonly Vector3i Offset_x0y0z0 = new Vector3i(0, 0, 0);
        public static readonly Vector3i Offset_x0y0z1 = new Vector3i(0, 0, 1);
        public static readonly Vector3i Offset_x0y1z0 = new Vector3i(0, 1, 0);
        public static readonly Vector3i Offset_x0y1z1 = new Vector3i(0, 1, 1);
        public static readonly Vector3i Offset_x1y0z0 = new Vector3i(1, 0, 0);
        public static readonly Vector3i Offset_x1y0z1 = new Vector3i(1, 0, 1);
        public static readonly Vector3i Offset_x1y1z0 = new Vector3i(1, 1, 0);
        public static readonly Vector3i Offset_x1y1z1 = new Vector3i(1, 1, 1);
