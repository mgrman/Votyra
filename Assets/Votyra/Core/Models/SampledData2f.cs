...
namespace Votyra.Core.Models
{
    public struct SampledData2f : IEquatable<SampledData2f>
    {
        ...
        public static SampledData2f operator -(SampledData2f a)
        {
            return new SampledData2f(-a.x0y0, -a.x0y1, -a.x1y0, -a.x1y1);
        }

        public static SampledData2f operator -(SampledData2f a, float b)
        {
            return new SampledData2f(a.x0y0 - b, a.x0y1 - b, a.x1y0 - b, a.x1y1 - b);
        }
        ...
        // }
        public static SampledData2f operator *(SampledData2f a, int b)
        {
            return new SampledData2f(a.x0y0 * b, a.x0y1 * b, a.x1y0 * b, a.x1y1 * b);
        }
        ...
        public SampledData2f ClipMin(float clipValue)
        {
            return new SampledData2f(Math.Max(this.x0y0, clipValue), Math.Max(this.x0y1, clipValue), Math.Max(this.x1y0, clipValue), Math.Max(this.x1y1, clipValue));
        }
        ...
        public SampledData2f GetRotated(int offset)
        {
            return new SampledData2f(GetIndexedValueCW(0 + offset), GetIndexedValueCW(1 + offset), GetIndexedValueCW(3 + offset), GetIndexedValueCW(2 + offset));
        }
        ...
        public static float Dif(SampledData2f a, SampledData2f b)
        {
        ...
        {
            var stepCount = MathUtils.RoundToInt(range.Size / step) +1;
    ...
    {
        public static SampledData2i ToSampledData2i(this SampledData2f data)
        {
            return new SampledData2i((int) data.x0y0, (int) data.x0y1, (int) data.x1y0, (int) data.x1y1);
        }
