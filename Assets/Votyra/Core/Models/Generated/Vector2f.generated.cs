...
namespace Votyra.Core.Models
{
    ...
    public static class Vector2fUtils
    {
        ...
        public static double Determinant(Vector2f a, Vector2f b)
        {
            ...
            public static Vector2f Ceil(this Vector2f @this) => new Vector2f(MathUtils.CeilToInt(@this.X), MathUtils.CeilToInt(@this.Y));
            
                public static Vector2i CeilToVector2i(this Vector2f @this) => new Vector2i(MathUtils.CeilToInt(@this.X), MathUtils.CeilToInt(@this.Y));
            
        
            public static Vector2f Abs(this Vector2f @this) => new Vector2f(Math.Abs(@this.X), Math.Abs(@this.Y));
            
        
            public static Vector2f Floor(this Vector2f @this) => new Vector2f(MathUtils.FloorToInt(@this.X), MathUtils.FloorToInt(@this.Y));
            
                public static Vector2i FloorToVector2i(this Vector2f @this) => new Vector2i(MathUtils.FloorToInt(@this.X), MathUtils.FloorToInt(@this.Y));
            
        
            public static Vector2f Round(this Vector2f @this) => new Vector2f(MathUtils.RoundToInt(@this.X), MathUtils.RoundToInt(@this.Y));
            
                public static Vector2i RoundToVector2i(this Vector2f @this) => new Vector2i(MathUtils.RoundToInt(@this.X), MathUtils.RoundToInt(@this.Y));
