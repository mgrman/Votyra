...
namespace Votyra.Core.Models
{
    ...
    public partial struct Vector6i : IEquatable<Vector6i>
    {
    ...
    public static class Vector6iUtils
    {
        ...
        public static Area6i ToArea6i(this Vector6i @this) => Area6i.FromMinAndSize(Vector6i.Zero, @this);
            ...
            public static Vector6i DivideUp(Vector6i a, Vector6i b) =>  new Vector6i(IntUtils.DivideUp(a.X0,  b.X0) , IntUtils.DivideUp(a.X1,  b.X1) , IntUtils.DivideUp(a.X2,  b.X2) , IntUtils.DivideUp(a.X3,  b.X3) , IntUtils.DivideUp(a.X4,  b.X4) , IntUtils.DivideUp(a.X5,  b.X5) );

            
            public static Vector6i DivideUp(Vector6i a, int b) =>  new Vector6i(IntUtils.DivideUp(a.X0,  b) , IntUtils.DivideUp(a.X1,  b) , IntUtils.DivideUp(a.X2,  b) , IntUtils.DivideUp(a.X3,  b) , IntUtils.DivideUp(a.X4,  b) , IntUtils.DivideUp(a.X5,  b) );
            public static Vector6i DivideUp(int a, Vector6i b) =>  new Vector6i(IntUtils.DivideUp(a,  b.X0) , IntUtils.DivideUp(a,  b.X1) , IntUtils.DivideUp(a,  b.X2) , IntUtils.DivideUp(a,  b.X3) , IntUtils.DivideUp(a,  b.X4) , IntUtils.DivideUp(a,  b.X5) );
