...
namespace Votyra.Core.Models
{
    ...
    public static class Vector4fUtils
    {
        ...
        public static float Dot(Vector4f a, Vector4f b) => (float)((double)a.X*b.X +  (double)a.Y*b.Y +  (double)a.Z*b.Z +  (double)a.W*b.W );
            ...
            public static Vector4f Ceil(this Vector4f @this) => new Vector4f(MathUtils.CeilToInt(@this.X), MathUtils.CeilToInt(@this.Y), MathUtils.CeilToInt(@this.Z), MathUtils.CeilToInt(@this.W));
            
                public static Vector4i CeilToVector4i(this Vector4f @this) => new Vector4i(MathUtils.CeilToInt(@this.X), MathUtils.CeilToInt(@this.Y), MathUtils.CeilToInt(@this.Z), MathUtils.CeilToInt(@this.W));
            ...
            public static Vector4f Floor(this Vector4f @this) => new Vector4f(MathUtils.FloorToInt(@this.X), MathUtils.FloorToInt(@this.Y), MathUtils.FloorToInt(@this.Z), MathUtils.FloorToInt(@this.W));
            
                public static Vector4i FloorToVector4i(this Vector4f @this) => new Vector4i(MathUtils.FloorToInt(@this.X), MathUtils.FloorToInt(@this.Y), MathUtils.FloorToInt(@this.Z), MathUtils.FloorToInt(@this.W));
            
        
            public static Vector4f Round(this Vector4f @this) => new Vector4f(MathUtils.RoundToInt(@this.X), MathUtils.RoundToInt(@this.Y), MathUtils.RoundToInt(@this.Z), MathUtils.RoundToInt(@this.W));
            
                public static Vector4i RoundToVector4i(this Vector4f @this) => new Vector4i(MathUtils.RoundToInt(@this.X), MathUtils.RoundToInt(@this.Y), MathUtils.RoundToInt(@this.Z), MathUtils.RoundToInt(@this.W));
