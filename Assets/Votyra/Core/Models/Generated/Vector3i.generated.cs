...
namespace Votyra.Core.Models
{
    ...
    public static class Vector3iUtils
    {
        ...
        public static Vector6f ToVector6f(this Vector3i @this,float x4, float x5, float x6 ) => new Vector6f(@this.X, @this.Y, @this.Z,  x4, x5, x6);
            ...
            public static Vector3i DivideUp(Vector3i a, Vector3i b) =>  new Vector3i(IntUtils.DivideUp(a.X,  b.X) , IntUtils.DivideUp(a.Y,  b.Y) , IntUtils.DivideUp(a.Z,  b.Z) );

            
            public static Vector3i DivideUp(Vector3i a, int b) =>  new Vector3i(IntUtils.DivideUp(a.X,  b) , IntUtils.DivideUp(a.Y,  b) , IntUtils.DivideUp(a.Z,  b) );
            public static Vector3i DivideUp(int a, Vector3i b) =>  new Vector3i(IntUtils.DivideUp(a,  b.X) , IntUtils.DivideUp(a,  b.Y) , IntUtils.DivideUp(a,  b.Z) );
