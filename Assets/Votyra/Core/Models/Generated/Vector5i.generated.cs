...
namespace Votyra.Core.Models
{
    ...
    public partial struct Vector5i : IEquatable<Vector5i>
    {
    ...
    public static class Vector5iUtils
    {
        ...
        public static Vector6f ToVector6f(this Vector5i @this,float x6 ) => new Vector6f(@this.X0, @this.X1, @this.X2, @this.X3, @this.X4,  x6);
            ...
            public static Vector5i DivideUp(Vector5i a, Vector5i b) =>  new Vector5i(IntUtils.DivideUp(a.X0,  b.X0) , IntUtils.DivideUp(a.X1,  b.X1) , IntUtils.DivideUp(a.X2,  b.X2) , IntUtils.DivideUp(a.X3,  b.X3) , IntUtils.DivideUp(a.X4,  b.X4) );

            
            public static Vector5i DivideUp(Vector5i a, int b) =>  new Vector5i(IntUtils.DivideUp(a.X0,  b) , IntUtils.DivideUp(a.X1,  b) , IntUtils.DivideUp(a.X2,  b) , IntUtils.DivideUp(a.X3,  b) , IntUtils.DivideUp(a.X4,  b) );
            public static Vector5i DivideUp(int a, Vector5i b) =>  new Vector5i(IntUtils.DivideUp(a,  b.X0) , IntUtils.DivideUp(a,  b.X1) , IntUtils.DivideUp(a,  b.X2) , IntUtils.DivideUp(a,  b.X3) , IntUtils.DivideUp(a,  b.X4) );
