...
namespace Votyra.Core.Models
{
    ...
    public static class Vector2iUtils
    {
        ...
        public static Vector6f ToVector6f(this Vector2i @this,float x3, float x4, float x5, float x6 ) => new Vector6f(@this.X, @this.Y,  x3, x4, x5, x6);
            ...
            public static Vector2i DivideUp(Vector2i a, Vector2i b) =>  new Vector2i(IntUtils.DivideUp(a.X,  b.X) , IntUtils.DivideUp(a.Y,  b.Y) );

            
            public static Vector2i DivideUp(Vector2i a, int b) =>  new Vector2i(IntUtils.DivideUp(a.X,  b) , IntUtils.DivideUp(a.Y,  b) );
            public static Vector2i DivideUp(int a, Vector2i b) =>  new Vector2i(IntUtils.DivideUp(a,  b.X) , IntUtils.DivideUp(a,  b.Y) );
