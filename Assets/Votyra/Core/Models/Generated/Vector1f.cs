...
namespace Votyra.Core.Models
{
    ...
    public static class Vector1fUtils
    {
        ...
        public static bool IsApproximatelyEqual(float a, float b) => a.IsApproximatelyEqual(b);

        public static bool IsApproximatelyEqual(float a, int b) => a.IsApproximatelyEqual(b);

        public static bool IsApproximatelyEqual(int a, float b) => MathUtils.IsApproximatelyEqual(a, b);
    }
}
