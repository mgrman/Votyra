...
namespace Votyra.Core.Models
{
    ...
    public static class Vector1fUtils
    {
        ...
        public static float Dot(float a, float b) => (float)((double)a*b );
            ...
            public static float Ceil(this float @this) => MathUtils.CeilToInt(@this);
            
                public static int CeilToVector1i(this float @this) => MathUtils.CeilToInt(@this);
            
        
            public static float Abs(this float @this) => Math.Abs(@this);
            
        
            public static float Floor(this float @this) => MathUtils.FloorToInt(@this);
            
                public static int FloorToVector1i(this float @this) => MathUtils.FloorToInt(@this);
            
        
            public static float Round(this float @this) => MathUtils.RoundToInt(@this);
            
                public static int RoundToVector1i(this float @this) => MathUtils.RoundToInt(@this);
