...
namespace Votyra.Core.Models
{
    ...
    public static class Vector4iUtils
    {
        ...
        public static Vector6f ToVector6f(this Vector4i @this,float x5, float x6 ) => new Vector6f(@this.X, @this.Y, @this.Z, @this.W,  x5, x6);
            ...
            public static Vector4i DivideUp(Vector4i a, Vector4i b) =>  new Vector4i(IntUtils.DivideUp(a.X,  b.X) , IntUtils.DivideUp(a.Y,  b.Y) , IntUtils.DivideUp(a.Z,  b.Z) , IntUtils.DivideUp(a.W,  b.W) );

            
            public static Vector4i DivideUp(Vector4i a, int b) =>  new Vector4i(IntUtils.DivideUp(a.X,  b) , IntUtils.DivideUp(a.Y,  b) , IntUtils.DivideUp(a.Z,  b) , IntUtils.DivideUp(a.W,  b) );
            public static Vector4i DivideUp(int a, Vector4i b) =>  new Vector4i(IntUtils.DivideUp(a,  b.X) , IntUtils.DivideUp(a,  b.Y) , IntUtils.DivideUp(a,  b.Z) , IntUtils.DivideUp(a,  b.W) );
