...
namespace Votyra.Core.Models
{
    ...
    public static class Vector3fUtils
    {
        ...
        public static float Dot(Vector3f a, Vector3f b) => (float)((double)a.X*b.X +  (double)a.Y*b.Y +  (double)a.Z*b.Z );
            ...
            public static Vector3f Ceil(this Vector3f @this) => new Vector3f(MathUtils.CeilToInt(@this.X), MathUtils.CeilToInt(@this.Y), MathUtils.CeilToInt(@this.Z));
            
                public static Vector3i CeilToVector3i(this Vector3f @this) => new Vector3i(MathUtils.CeilToInt(@this.X), MathUtils.CeilToInt(@this.Y), MathUtils.CeilToInt(@this.Z));
            
        
            public static Vector3f Abs(this Vector3f @this) => new Vector3f(Math.Abs(@this.X), Math.Abs(@this.Y), Math.Abs(@this.Z));
            
        
            public static Vector3f Floor(this Vector3f @this) => new Vector3f(MathUtils.FloorToInt(@this.X), MathUtils.FloorToInt(@this.Y), MathUtils.FloorToInt(@this.Z));
            
                public static Vector3i FloorToVector3i(this Vector3f @this) => new Vector3i(MathUtils.FloorToInt(@this.X), MathUtils.FloorToInt(@this.Y), MathUtils.FloorToInt(@this.Z));
            
        
            public static Vector3f Round(this Vector3f @this) => new Vector3f(MathUtils.RoundToInt(@this.X), MathUtils.RoundToInt(@this.Y), MathUtils.RoundToInt(@this.Z));
            
                public static Vector3i RoundToVector3i(this Vector3f @this) => new Vector3i(MathUtils.RoundToInt(@this.X), MathUtils.RoundToInt(@this.Y), MathUtils.RoundToInt(@this.Z));
