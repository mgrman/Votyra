...
namespace Votyra.Core.Models
{
    public struct Ray5f : IEquatable<Ray5f>
    {
        ...
        public Vector5f ToAt1 => this.Origin + this.Direction;
        ...
        public Vector5f GetPoint(float distance) => this.Origin + (this.Direction * distance);

        public bool Equals(Ray5f other) => this.Origin.Equals(other.Origin) && this.Direction.Equals(other.Direction);
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is Ray5f other && this.Equals(other);
        }
