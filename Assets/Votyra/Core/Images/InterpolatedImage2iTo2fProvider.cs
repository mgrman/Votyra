...
//                    {
//                        return new NNImage2fInvalidatableWrapper(image, _interpolationConfig.Subdivision);
//                    }
//                    else
//                    {
//                        return new NNImage2fWrapper(image, _interpolationConfig.Subdivision);
//                    }
//                case IntepolationAlgorithm.Linear:
//                    if (image is IImageInvalidatableImage2i)
//                    {
//                        return new LinearImage2fInvalidatableWrapper(image, _interpolationConfig.Subdivision);
//                    }
//                    else
//                    {
//                        return new LinearImage2fWrapper(image, _interpolationConfig.Subdivision);
//                    }
                case IntepolationAlgorithm.Cubic:
                    if (image is IImageInvalidatableImage2i)
                    {
                        return new CubicImage2fWrapper(image, _interpolationConfig.Subdivision);
                    }
                    else
                    {
                        return new CubicImage2fInvalidatableWrapper(image, _interpolationConfig.Subdivision);
                    }
                default:
        ...
        private class CubicImage2fWrapper : IImage2f
        {
            ...
            public Height1f Sample(Vector2i point)
            {
                ...
                float col0 = Intepolate(_interpolationMatrix[0, 0], _interpolationMatrix[1, 0],
                    _interpolationMatrix[2, 0],
                    _interpolationMatrix[3, 0], fraction.X);
                float col1 = Intepolate(_interpolationMatrix[0, 1], _interpolationMatrix[1, 1],
                    _interpolationMatrix[2, 1],
                    _interpolationMatrix[3, 1], fraction.X);
                float col2 = Intepolate(_interpolationMatrix[0, 2], _interpolationMatrix[1, 2],
                    _interpolationMatrix[2, 2],
                    _interpolationMatrix[3, 2], fraction.X);
                float col3 = Intepolate(_interpolationMatrix[0, 3], _interpolationMatrix[1, 3],
                    _interpolationMatrix[2, 3],
                    _interpolationMatrix[3, 3], fraction.X);
        ...
        {
            public CubicImage2fInvalidatableWrapper(IImage2i image, int subdivision)
