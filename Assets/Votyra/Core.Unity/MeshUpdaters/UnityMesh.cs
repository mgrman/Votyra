...
namespace Votyra.Core.TerrainMeshes
{
    public class UnityMesh : IDisposable
    {
        ...
        public UnityMesh(Bounds meshBounds, IReadOnlyList<Vector3> vertices, IReadOnlyList<Vector3> normals, IReadOnlyList<Vector2> uv, IReadOnlyList<int> indices, Action onDisposed)
        {
