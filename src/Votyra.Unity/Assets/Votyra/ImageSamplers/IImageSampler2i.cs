...
namespace Votyra.ImageSamplers
{
    ...
    {
        SampledData2i Sample(IImage2i image, Vector2i offset);


        Vector2 WorldToImage(Vector2 pos);

        int SampleX0Y0(IImage2i image, Vector2i pos);
        int SampleX0Y1(IImage2i image, Vector2i pos);
        int SampleX1Y0(IImage2i image, Vector2i pos);
        int SampleX1Y1(IImage2i image, Vector2i pos);
