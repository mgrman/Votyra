...
namespace TycoonTerrain.TerrainMeshers.TriangleMesh
{
    public class FixedTriangleMesh : ITriangleMesh
    {
        ...
        IList<Vector3> ITriangleMesh.Vertices { get { return Vertices; } }
        IList<Vector3> ITriangleMesh.Normals { get { return Normals; } }
        IList<Vector2> ITriangleMesh.UV { get { return UV; } }
        IList<int> ITriangleMesh.Indices { get { return Indices; } }
