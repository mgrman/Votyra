...
{
    internal class NoiseImage : MonoBehaviour, IImage2iProvider
    {
        ...
        {
            _image = new RoundImage(new TycoonTerrain.Images.NoiseImage(offset.ToDomain(),scale.ToDomain(), timeRounding, timeScale));
        }
    }
}